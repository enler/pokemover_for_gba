...
ALIGNED(4) const u8 gFontSmallChineseGlyphsWidths = 10;
ALIGNED(4) const u8 gFontNormalChineseGlyphsWidths = 12;
ALIGNED(4) const u16 gFontSmallChineseCHSGlyphs[] = INCBIN_U16("graphics/fonts/chinese_small_CHS.latfont");
ALIGNED(4) const u16 gFontNormalChineseCHSGlyphs[] = INCBIN_U16("graphics/fonts/chinese_normal_CHS.latfont");
ALIGNED(4) const u16 gFontSmallChineseCHTGlyphs[] = INCBIN_U16("graphics/fonts/chinese_small_CHT.latfont");
ALIGNED(4) const u16 gFontNormalChineseCHTGlyphs[] = INCBIN_U16("graphics/fonts/chinese_normal_CHT.latfont");