...
} static const sMainMenuTexts[OPTIONS_COUNT] =
{
    ...
    [OPITON_TRANSFER_FROM_GSC] = {gText_TransferFromGSC, gText_TransferFromGSCDescription},
...
const u32 sScrollingBg_Gfx[]          = INCBIN_U32("graphics/pokemon_storage/scrolling_bg.4bpp.lz");
const u32 sScrollingBg_Tilemap[]      = INCBIN_U32("graphics/pokemon_storage/scrolling_bg.bin.lz");
...
const u16 sScrollingBg_Pal[]          = INCBIN_U16("graphics/pokemon_storage/scrolling_bg.gbapal");
...
const struct SpriteTemplate sSpriteTemplate_MonIcon =
{
...
static void Task_PCMainMenu(u8 taskId)
{
    ...
    case STATE_HANDLE_INPUT:
        ...
        case MENU_NOTHING_CHOSEN:
            ...
            break;
        case OPITON_TRANSFER_FROM_GSC:
            InitSave();
            ClearStdWindowAndFrame(task->tWindowId, TRUE);
            RemoveWindow(task->tWindowId);
            task->tState = STATE_START_POKEMOVER;
            break;
        case MENU_B_PRESSED:
        case OPTION_EXIT:
            ClearStdWindowAndFrame(task->tWindowId, TRUE);
    ...
    case STATE_ENTER_PC:
        ...
        break;
    case STATE_START_POKEMOVER:
        switch(RunSaveCallback())
        {
            case SAVE_CANCELED:
            case SAVE_ERROR:
                task->tState = STATE_LOAD;
                break;
            case SAVE_SUCCESS:
                CleanupOverworldWindowsAndTilemaps();
                ShowPokeMoverScreen(task->tInput);
                RemoveWindow(task->tWindowId);
                DestroyTask(taskId);
                break;
