...
bool8 IsChineseGlyph(u16 glyph)
{
...
u16 GetChineseChar(struct TextPrinter *textPrinter, u16 currChar)
{
    if (currChar >= 0x1C && currChar <= 0x1E) {
        currChar -= 2;} 
    else if(currChar >= 0x07 && currChar <= 0x1A) {
        currChar -= 1;} 
        
    currChar = (currChar << 8) | *textPrinter->printerTemplate.currentChar; //组合双字节
    currChar += 0x0100;//避开emoji表
    textPrinter->printerTemplate.currentChar++;
    return currChar;
}

u8 GetChineseGlyphswidth( u8 fontId )
{
    int glyphWidth;
    ...
    {
        case FONT_SMALL://0
        case FONT_SMALL_NARROW://8
            glyphWidth = gFontSmallChineseGlyphsWidths;//10
        case FONT_NORMAL://1
        case FONT_SHORT://2
        case FONT_NARROW://7
            glyphWidth = gFontNormalChineseGlyphsWidths;//12
    }
    return glyphWidth;
}
...
static u16 RenderText(struct TextPrinter *textPrinter)
{
    ...
    case RENDER_STATE_HANDLE_CHAR:
        ...
        case CHAR_CHINESE_01:
        case CHAR_CHINESE_02:
        case CHAR_CHINESE_03:
        case CHAR_CHINESE_04:
        case CHAR_CHINESE_05:
        case CHAR_CHINESE_06:
        case CHAR_CHINESE_07:
        case CHAR_CHINESE_08:
        case CHAR_CHINESE_09:
        case CHAR_CHINESE_10:
        case CHAR_CHINESE_11:
        case CHAR_CHINESE_12:
        case CHAR_CHINESE_13:
        case CHAR_CHINESE_14:
        case CHAR_CHINESE_15:
        case CHAR_CHINESE_16:
        case CHAR_CHINESE_17:
        case CHAR_CHINESE_18:
        case CHAR_CHINESE_19:
        case CHAR_CHINESE_20:
        case CHAR_CHINESE_21:
        case CHAR_CHINESE_22:
        case CHAR_CHINESE_23:
        case CHAR_CHINESE_24:
        case CHAR_CHINESE_25:
        case CHAR_CHINESE_26:
        case CHAR_CHINESE_27:
        case CHAR_CHINESE_28:
            currChar = GetChineseChar(textPrinter, currChar);
            break;
        }
...
s32 GetStringWidth(u8 fontId, const u8 *str, s16 letterSpacing)
{
    ...
    while (*str != EOS)
    {
        ...
        case 0x07 ... 0x1A:
        case 0x1C ... 0x1E:
            glyphWidth = GetChineseGlyphswidth( fontId );
...
static void DecompressGlyph_Small(u16 glyphId, bool32 isJapanese)
{
    ...
    else
    {
        if (glyphId >= 0x0200)
        {
            u16 index = glyphId - 0x0200;
            glyphs = gFontSmallChineseCHSGlyphs + (0x20 * index); 
            gCurGlyph.width = gFontSmallChineseGlyphsWidths;
        }
        else
        {
...
static void DecompressGlyph_Narrow(u16 glyphId, bool32 isJapanese)
{
    ...
    else
    {
        ...
        {
            u16 index = glyphId - 0x0200;
            glyphs = gFontNormalChineseCHSGlyphs + (0x20 * index); 
            gCurGlyph.width = gFontNormalChineseGlyphsWidths;
        }
        else
        {
