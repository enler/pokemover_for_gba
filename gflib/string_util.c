...
const u8 *GetExpandedPlaceholder(u32 id)
{
    ...
    {
        [PLACEHOLDER_ID_UNKNOWN]      = NULL,
        [PLACEHOLDER_ID_PLAYER]       = NULL,
        ...
        [PLACEHOLDER_ID_KUN]          = NULL,
        [PLACEHOLDER_ID_RIVAL]        = NULL,
        [PLACEHOLDER_ID_VERSION]      = NULL,
        [PLACEHOLDER_ID_AQUA]         = NULL,
        [PLACEHOLDER_ID_MAGMA]        = NULL,
        [PLACEHOLDER_ID_ARCHIE]       = NULL,
        [PLACEHOLDER_ID_MAXIE]        = NULL,
        [PLACEHOLDER_ID_KYOGRE]       = NULL,
        [PLACEHOLDER_ID_GROUDON]      = NULL,
    };
